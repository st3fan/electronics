...
//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
char data0=4;	// Digit 0 data
char data1=3;	// Digit 1 data
char data2=2;	// Digit 2 data
char data3=1;	// Digit 3 data
...
void check_Special(void)
{
    ...
    // Update DPStatus
    else if ((data0=='w')&&(receiveCount==2))
    {
        DPStatus = data1;
    ...
    else if ((data0=='y')&&(receiveCount==2))
    {
        switch(data1)
        {
          case 0:	// 2400
